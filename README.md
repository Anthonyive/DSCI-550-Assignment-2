...
1. **[Task 3]** Jupyter notebook called [3.ipynb](notebooks/3.ipynb)
   ...
   *Summary:* The notebook implements the TTR algorithm in Tika Python that takes the XHTML representation and extracts out the relevant text. Finally, it adds a new column representing the TTR’ed resulting text.
